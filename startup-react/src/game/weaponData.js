export const weapons = [
  { name: 'Liberator', category: 'Primary', type: 'Assault Rifle', damage: 80, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  { name: 'Liberator Penetrator', category: 'Primary', type: 'Assault Rifle', damage: 60, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'Liberator Concussive', category: 'Primary', type: 'Assault Rifle', damage: 65, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  { name: 'StA-52 Assault Rifle', category: 'Primary', type: 'Assault Rifle', damage: 80, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  { name: 'Pacifier', category: 'Primary', type: 'Assault Rifle', damage: 50, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['Stun'] },
  { name: 'Coyote', category: 'Primary', type: 'Assault Rifle', damage: 75, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['Incendiary'] },
  { name: 'MA5C Assault Rifle', category: 'Primary', type: 'Assault Rifle', damage: 80, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'Liberator Carbine', category: 'Primary', type: 'Assault Rifle', damage: 80, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  ...
  { name: 'Knight', category: 'Primary', type: 'Submachine Gun', damage: 70, armorPen: 'Light (2)', armorPenValue: 2, traits: ['One Handed'] },
  { name: 'StA-11 SMG', category: 'Primary', type: 'Submachine Gun', damage: 70, armorPen: 'Light (2)', armorPenValue: 2, traits: ['One Handed'] },
  ...
  { name: 'Reprimand', category: 'Primary', type: 'Submachine Gun', damage: 125, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'Defender', category: 'Primary', type: 'Submachine Gun', damage: 80, armorPen: 'Light (2)', armorPenValue: 2, traits: ['One Handed'] },
  { name: 'Pummeler', category: 'Primary', type: 'Submachine Gun', damage: 70, armorPen: 'Light (2)', armorPenValue: 2, traits: ['One Handed'] },
  { name: 'Punisher', category: 'Primary', type: 'Shotgun', damage: 405, armorPen: 'Light (2)', armorPenValue: 2, traits: ['Rounds Reload'] },
  { name: 'Slugger', category: 'Primary', type: 'Shotgun', damage: 280, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['Rounds Reload'] },
  ...
  { name: 'Punisher Plasma', category: 'Primary', type: 'Energy-Based', damage: 250, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['Explosive'] },
  ...
  { name: 'Sickle', category: 'Primary', type: 'Energy-Based', damage: 55, armorPen: 'Light (2)', armorPenValue: 2, traits: ['Heat'] },
  ...
  { name: 'Peacemaker', category: 'Secondary', type: 'Pistol', damage: 85, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  { name: 'Redeemer', category: 'Secondary', type: 'Pistol', damage: 60, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  { name: 'Verdict', category: 'Secondary', type: 'Pistol', damage: 125, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'M6C/SOCOM Pistol', category: 'Secondary', type: 'Pistol', damage: 100, armorPen: 'Light (2)', armorPenValue: 2, traits: ['Suppressed'] },
  ...
  { name: 'Saber', category: 'Secondary', type: 'Melee', damage: 110, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'Stun Baton', category: 'Secondary', type: 'Melee', damage: 50, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['Stun'] },
  { name: 'Combat Hatchet', category: 'Secondary', type: 'Melee', damage: 110, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  { name: 'Machete', category: 'Secondary', type: 'Melee', damage: 170, armorPen: 'Medium (3)', armorPenValue: 3, traits: ['None'] },
  ...
  { name: 'Stalwart', category: 'Support', type: 'Heavy Weapon', damage: 80, armorPen: 'Light (2)', armorPenValue: 2, traits: ['None'] },
  ...
  { name: 'Autocannon', category: 'Support', type: 'Heavy Explosive', damage: 410, armorPen: 'Heavy (4)', armorPenValue: 4, traits: ['Backpack', 'Stationary Reload'] },
  ...
  { name: 'W.A.S.P. Launcher', category: 'Support', type: 'Missiles', damage: 800, armorPen: 'Anti-Tank II (6)', armorPenValue: 6, traits: ['Backpack', 'Stationary Reload', 'Guided'] },
  ...
  { name: 'De-Escalator', category: 'Support', type: 'Tesla', damage: 55, armorPen: 'Heavy (4)', armorPenValue: 4, traits: ['Stun'] },
