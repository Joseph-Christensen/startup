...
Output How would you use JavaScript to select an element with the id of “byu” and change the text
...
Which of the following is true for the domain name banana.fruit.bozo.click, which is the 
top
